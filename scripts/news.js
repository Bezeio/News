...
const categories = getFromStorage('category') || 'General'
let currentPage = 1;
...
const getNewsData = async () => {
  try {
    const response = await fetch(
      `https://newsapi.org/v2/everything?q=${categories}&apiKey=61a9170707e5499a99e3b282c27f0f28&sortBy=popularity&pageSize=${pageSize}&page=${currentPage}`
    );
